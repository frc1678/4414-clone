...
public final class Rotation2 implements Interpolable<Rotation2>,com.team254.lib.util.Interpolable<Rotation2>,Serializable {
    /**
    ...
    /**
     * Create a new rotation that is empty and only holds space
     * 
     * */
    public Rotation2() {
        this(1, 0, false);
