...
public class Superstructure extends Subsystem{
    ...
    //for dropping intake command
    public synchronized void setWantDroppingIntake(Rotation2d mTurret.getAngle) {
        mTurretSetpoint = Math.abs(mSuperstructure.mTurret.getAngle.getDegrees() - 90);
    }

    public boolean isDroppingIntake(){
        if(mTurretAngle = -90) {
            return true;
        }
        else {
